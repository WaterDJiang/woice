...
final class PiConnectorRouter {
  ...
  func handle(_ request: PiConnectorRequest) -> PiConnectorResponse {
    do {
      ...
      return PiConnectorResponse(
        ...
        error: PiConnectorErrorPayload(code: "INVALID_REQUEST", message: error.localizedDescription)
      )
    } catch {
      return PiConnectorResponse(
        requestID: request.requestID,
        error: PiConnectorErrorPayload(code: "INTERNAL_ERROR", message: error.localizedDescription)
      )
    }
  }
    ...
    -> PiConnectorResponse
  {
    PiConnectorResponse(
      requestID: request.requestID,
      error: PiConnectorErrorPayload(code: "ROUTER_ERROR", message: error.localizedDescription)
    )
  }
