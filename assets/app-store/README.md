...
本目录先准备可直接进入 App Store Connect 的资料骨架；真实产品截图仍需从最终签名 Build 采集，不用宣传稿或生成图冒充产品界面。
...
- Bundle ID、SKU、Team ID、签名、公证和上传 Build。
- 隐私政策 URL、支持 URL、营销 URL、版权人信息。
- 最终 UI 截图、App Preview 视频、年龄分级答案和出口合规答案。
