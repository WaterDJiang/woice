...
| Mac App Store 上架 | Build 7 因 Guideline 2.4.5 与系统音频说明被拒；Build 8 已完成修复、全门禁、Archive、导出和上传，待 Apple 处理、实机验收、审核回复与重提 | 单一 Store Edition 的正式审核与手动发布；不替代官网 Core/Offline 的 Developer ID/公证计划 | [2026-08-23-mac-app-store-launch.md](2026-08-23-mac-app-store-launch.md) |
