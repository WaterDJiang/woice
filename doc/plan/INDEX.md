...
| M2-08 | 既有闭环完成；WCL-07 一键安装/Qwen Runtime 待实施，WCL-04 发行验证待凭据 | 保留现有 ASR/WhisperKit/Core/Offline；新增三个入口共用的一键模型安装、等待任务恢复与 Store-compatible Qwen Runtime | [2026-08-22-model-integration.md](2026-08-22-model-integration.md) |
...
| 当前技术开发收口 | 唯一活动开发计划；WCL-07 本机模型一键安装与 Store-compatible Qwen Runtime 待实施，WCL-04 发行验证与 WCL-06 签名 Archive 仍待外部条件 | WCL-00～07 只承接代码、自动测试、发行工程、Agent 安全和 MAS 工程；真实用户、真实会议与人工体验仅作提醒 | [2026-08-24-current-technical-development-closure.md](2026-08-24-current-technical-development-closure.md) |
...
| 当前计划进度复核 | 2026-08-25 已更新 | 既有基线保持；新增 WCL-07 一键模型安装与 Qwen Store-compatible Runtime 待实施，发行和 Store 外部条件保持原边界 | [2026-08-23-plan-progress-review.md](2026-08-23-plan-progress-review.md) |
